...
namespace SixMan.ChiMa.Migrations
{
    ...
    [Migration("20180114012716_add_CokeryNote")]
    partial class add_CokeryNote
    {
            ...
            modelBuilder.Entity("SixMan.ChiMa.Domain.Dish.CookeryNote", b =>
                {
                    ...
                    b.HasOne("SixMan.ChiMa.Domain.Family.UserInfo", "UerInfo")
                        .WithMany()
                        .HasForeignKey("UerInfoId");
                });
