...
using SixMan.ChiMa.Web.Models.Account;
...
using SixMan.ChiMa.Web.Views.Shared.Components.TenantChange;
using Microsoft.AspNetCore.Identity;
using SixMan.ChiMa.Application.Authorization;
using SixMan.ChiMa.Domain;
using SixMan.ChiMa.Identity;

namespace SixMan.ChiMa.Web.Controllers
{
    public class AccountController : ChiMaControllerBase
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            try
            {
                ...
                if (model.IsExternalLogin)
                {
                    ...
                    model.Password = Domain.Authorization.Users.User.CreateRandomPassword();
                }
                else
                {
